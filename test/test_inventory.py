...
def test_ui_menu(driver_logged):
...
def test_ui_filtro(driver_logged):
...
def test_ui_carrito(driver_logged):
    carrito = driver_logged.find_element(By.CLASS_NAME,"shopping_cart_link")
    assert carrito.is_displayed(), "El icono carrito no está presente en la página"
